...
## Objetivo
Tres experiencias que se sientan del mismo producto Aris, reutilizando el design system y su tono de microcopy.
...
- Sección “Asistente”: tono, sugerencias, o límites (todo simulado).

## Definición de hecho
- Navegación clara vuelta atrás en subpantallas.
- Copys alineados con regla `03_estilo_visual_aris.md` (tono, no jerga técnica al usuario).
