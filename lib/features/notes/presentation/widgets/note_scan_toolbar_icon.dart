...
/// Marco de escaneo: misma altura óptica que tabla (v0.49.41).
...
class _NoteScanToolbarIconPainter extends CustomPainter {
  ...
  static const double _frameHeight = NoteToolbarIconStyle.tableFrameHeight;
  static const double _frameWidth = 20;
  static const double _cornerRadius = 3.5;
  static const double _sideGap = 2.8;

  @override
  void paint(Canvas canvas, Size size) {
    final paint = NoteToolbarIconStyle.stroke(color);

    final top = (size.height - _frameHeight) / 2;
    final bottom = top + _frameHeight;
    final left = (size.width - _frameWidth) / 2;
    final right = left + _frameWidth;
    ...
    final lineLeft = left + 3.5;
    final lineRight = right - 3.5;
